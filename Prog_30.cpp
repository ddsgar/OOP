//30.	Написать программу, моделирующую управление каталогом в файловой системе.
...
//− удаление файлов, дата создания которых раньше заданной; − выборку файла с наибольшим количеством обращений.
