//11.	Определить класс «Шахматная фигура» и унаследовать от него классы,
//соответствующие шахматным фигурам «Король», «Ферзь», «Ладья», «Слон», «Конь», «Пешка». 
//Задать позицию на доске и определить, не стоит ли мат одному из королей.
