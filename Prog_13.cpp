//13.	Определить класс «Дата», описывающий дату. Реализовать в классе методы, позволяющие: 
//вводить дату, выводить дату в разных форматах (1.09.2010 или 1 сентября 2010, или 01.09.10), 
//вычислять расстояние между датами в днях, вычислять день недели для заданной даты, 
//проверять корректность заданной даты. В программе продемонстрировать использование объектов класса «Дата».
