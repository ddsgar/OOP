//19.	Разработать класс «Стек», реализующий функционирования стека (LIFO;LastIn,FirstOut;  «последним пришел – первым вышел»). 
//В классе реализовать возможность добавление и удаление элемента, проверки, не пуст и не переполнен ли стек, 
//получения количества элементов в стеке. 
//Функции добавления и удаления информации в/из стека реализовать как перегрузку операций сложения и вычитания.
