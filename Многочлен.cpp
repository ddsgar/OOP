//16.	Определить класс «Многочлен», описывающий алгебраический многочлен от однойпеременной, 
//задаваемой степенью многочлена и массивом коэффициентов. Реализовать в классе методы, 
//позволяющие вычислять значения многочлена для заданного аргумента, выполнять операции сложения, 
//вычитания и умножения многочленов, взятия производной произвольного порядка с получением нового объекта-многочлена. 
//В программе продемонстрировать использование объектов класса «Многочлен».
